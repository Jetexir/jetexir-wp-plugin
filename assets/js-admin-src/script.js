jQuery(document).ready(function ($) {
    ...
    if (waSettingsSectionLinks.length) {
        ...
        if (waSectionActiveLink.position().left - 100 < 0) {
            waSettingsSectionLinks.animate({
                scrollLeft: waSectionActiveLink.position().left - waSectionActiveLink.outerWidth(true) - (waSettingsSectionLinks.outerWidth() / 3)
            }, 500);
        }
    }
