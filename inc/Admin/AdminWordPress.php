...
class AdminWordPress implements AdminTabInterface {
  ...
  public function settings(): array {
    if ( self::$settings === null ) {
      /**
       * Filters the WordPress settings sections.
       *
