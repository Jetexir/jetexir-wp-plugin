...
class WooDeveloperFeed extends Addon implements AddonInterface {
  ...
  public function info(): array {
    $svg = '<svg width="200" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
	 viewbox="0 0 183.6 47.5" xml:space="preserve">
<g style="fill-rule:evenodd; clip-rule:evenodd; fill:#873EFF;">
	<path style="fill-rule:evenodd; clip-rule:evenodd; fill:#873EFF;" class="st0" d="M77.4,0c-4.3,0-7.1,1.4-9.6,6.1L56.4,27.6V8.5c0-5.7-2.7-8.5-7.7-8.5s-7.1,1.7-9.6,6.5L28.3,27.6V8.7
	...
	<path style="fill-rule:evenodd; clip-rule:evenodd; fill:#873EFF;" class="st0" d="M108.6,0C95,0,84.7,10.1,84.7,23.8s10.4,23.7,23.9,23.7s23.8-10.1,23.9-23.7C132.5,10.1,122.1,0,108.6,0z
		 M108.6,32.9c-5.1,0-8.6-3.8-8.6-9.1s3.5-9.2,8.6-9.2s8.6,3.9,8.6,9.2S113.8,32.9,108.6,32.9z"/>
	<path style="fill-rule:evenodd; clip-rule:evenodd; fill:#873EFF;" class="st0" d="M159.7,0c-13.5,0-23.9,10.1-23.9,23.8s10.4,23.7,23.9,23.7s23.9-10.1,23.9-23.7S173.2,0,159.7,0z M159.7,32.9
